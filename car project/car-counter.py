...
mask=cv2.imread("D:/samni/computer vision projects/projects/object detection/car project/Untitled design.png")
...
while True:
    ...
    # Resize mask to match video frame dimensions
    mask = cv2.resize(mask, (img.shape[1], img.shape[0]))
    
    imgRegion = cv2.bitwise_and(img, mask)
    imgGraphics = cv2.imread("car project/graphics.png", cv2.IMREAD_UNCHANGED)
